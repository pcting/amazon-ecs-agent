...
docker: certs build-in-docker
	...
	@docker build -f scripts/dockerfiles/Dockerfile.release -t "videoamp/amazon-ecs-agent:1.7.1-1.0" .
	@echo "Built Docker image \"videoamp/amazon-ecs-agent:1.7.1-1.0\""
